...
class Parameters
{
    public:
        ...
        // mutation probability of the prior mean in perceived x
        double mu_prior_mean_x{0.05};
        // mutation probability of the prior stddev in perceived x
        double mu_prior_sigma_x{0.05};

        // standard deviation of any normally distributed effect sizes
        // (i.e., mutations of prior mean and stddev)
        double mu_stddev{0.05};
        ...
        // initial values of the prior
        double init_prior_mean_x{0.0};
        double init_prior_sigma_x{1.0};
